...
$qStr = "SELECT resetToken, resetComplete FROM Member WHERE resetToken = '".$token."'";
$error[] = "SELECT string: '".$qStr."'";
...
if(isset($_POST['submit'])){
    ...
    if(!isset($error)){
        ...
        $uStr = "UPDATE Member SET password = '".$hashedpassword."', resetComplete = 'Yes' "
